export const zh = {
  ...
  updatingPlugin: '更新中…',
  updateError: '更新失败',
  restartRequired: '需要重启 DeepSeek Harness 才能加载更新后的插件。',
...
export const en = {
  ...
  toolOutput: 'Output',
  toolAnswers: 'Answers',
  steeredMessage: 'Your steered message',
  toolError: 'Error',
  markdownCopy: 'Copy',
  ...
  restartRequired: 'Restart DeepSeek Harness to load the updated plugin.',
  updateSource_registry: 'npm',
