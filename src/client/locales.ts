export const zh = {
  ...
  planUsage: '账号额度',
  planUsageBody: '当前 Claude 订阅的用量窗口，来自 Claude Code 的 /usage 数据。会话空闲时自动刷新。',
  ...
  planUsageNoSession: '没有活跃的 Claude 会话，显示的是上次缓存的数据。',
  planUsageBusy: 'Claude 会话正忙，显示的是上次缓存的数据；会话空闲后会自动刷新。',
...
export const en = {
  ...
  planUsageBody: "Utilization windows for the signed-in Claude subscription, from Claude Code's /usage data. Refreshes whenever a session goes idle.",
  ...
  planUsageNoSession: 'No live Claude session; showing the last cached values.',
  planUsageBusy: 'Every Claude session is mid-turn; showing the last cached values. They refresh on their own once a session goes idle.',
