export const zh = {
  ...
  jiraTitle: 'Jira',
  jiraBody: '连接 Jira Cloud 后，新会话可以直接从 ticket 开工：分支按 ticket key 命名，输入框预填 ticket 简报。',
  jiraSite: '站点地址',
...
export const en = {
  ...
  jiraTitle: 'Jira',
  jiraBody: 'Connect Jira Cloud to start new sessions from a ticket: the branch is named after the ticket key and the composer is seeded with the ticket brief.',
  jiraSite: 'Site URL',
  jiraSitePlaceholder: 'https://your-team.atlassian.net',
