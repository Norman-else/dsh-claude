export const zh = {
  ...
  heroIssue: 'Issue',
  heroIssueMenu: '从 GitHub Issue 开始',
  heroIssueLoading: '正在读取 Issues…',
  heroIssueEmpty: '没有打开的 Issue',
  heroIssueNone: '不关联 Issue',
  heroIssueFailed: 'Issues 读取失败',
...
export const en = {
  ...
  heroIssue: 'Issue',
  heroIssueMenu: 'Start from a GitHub issue',
  heroIssueLoading: 'Loading issues…',
  heroIssueEmpty: 'No open issues',
  heroIssueNone: 'No issue',
  heroIssueFailed: 'Issues could not be loaded',
  cleanupButton: 'Clean up',
